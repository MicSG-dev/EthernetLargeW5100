/*
                              Web Client Multiple SSL

   This sketch connects to two different websites with a
   secure HTTPS connection (https://sistemas.micsg.com.br/ethernet-large-get-example AND https://arduino.cc)
   using a W5500 module.

                      created on December 18, 2009
                          by David A. Mellis

                        modified on May 6, 2024
...
char server1[] = "sistemas.micsg.com.br";          // name address for site 1
char query1[] = "GET /ethernet-large-get-example"; // https://sistemas.micsg.com.br/ethernet-large-get-example

char server2[] = "economia.awesomeapi.com.br"; // name address for site 2
char query2[] = "GET /last/USD-BRL";           // https://economia.awesomeapi.com.br/last/USD-BRL
...
void setup()
{
    ...
    Serial.println();
    Serial.println("Connecting to the first site...");
...
void loop()
{
    ...
    if (!client.connected())
    {
        ...
        Serial.println();
        Serial.println("Connecting to the second site...");
        // if you get a connection, report back via serial:
