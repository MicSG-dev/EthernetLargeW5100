/*
     ...
     https://www.bearssl.org/x509.html

     The SSLClient library uses BearSSL's minimal x.509 verification engine to verify
     the certificate of an SSL connection. This mechanism requires the developer to create a matrix
     of trusted anchors using values stored in trusted root certificates. In short,
     These trust anchor matrices allow BearSSL to verify that the server it
     is connected is who he says he is, not someone malicious.

     BearSSL X.509 certificate generator: https://openslab-osu.github.io/bearssl-certificate-utility/
*/
 ...
 * Domain(s): sistemas.micsg.com.br
 * 
 * Index:    1
 * Label:    DST Root CA X3
 * Subject:  CN=DST Root CA X3,O=Digital Signature Trust Co.
 * Domain(s): economia.awesomeapi.com.br
 */
